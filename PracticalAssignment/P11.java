...
public class P11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Jay Thanki", 26, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Aman", 20, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Meet", 89, 'M');
